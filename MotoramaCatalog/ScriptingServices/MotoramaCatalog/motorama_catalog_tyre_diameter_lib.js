...
exports.createMotorama_catalog_tyre_diameter = function() {
...
exports.readMotorama_catalog_tyre_diameterEntity = function(id) {
    var connection = datasource.getConnection();
    try {
        var result;
        var sql = "SELECT * FROM MOTORAMA_CATALOG_TYRE_DIAMETER WHERE " + exports.pkToSQL();
        var statement = connection.prepareStatement(sql);
...
exports.readMotorama_catalog_tyre_diameterList = function(limit, offset, sort, desc) {
    var connection = datasource.getConnection();
    try {
        var result = [];
        var sql = "SELECT ";
        ...
        sql += " * FROM MOTORAMA_CATALOG_TYRE_DIAMETER";
        if (sort !== null) {
            sql += " ORDER BY " + sort;
        }
...
// update entity by id
exports.updateMotorama_catalog_tyre_diameter = function() {
    var input = request.readInputText();
...
// delete entity
exports.deleteMotorama_catalog_tyre_diameter = function(id) {
    var connection = datasource.getConnection();
    try {
    	var sql = "DELETE FROM MOTORAMA_CATALOG_TYRE_DIAMETER WHERE " + exports.pkToSQL();
        var statement = connection.prepareStatement(sql);
...
exports.countMotorama_catalog_tyre_diameter = function() {
    var count = 0;
    var connection = datasource.getConnection();
    try {
    	var sql = 'SELECT COUNT(*) FROM MOTORAMA_CATALOG_TYRE_DIAMETER';
        var statement = connection.prepareStatement(sql);
...
exports.metadataMotorama_catalog_tyre_diameter = function() {
	var entityMetadata = {
