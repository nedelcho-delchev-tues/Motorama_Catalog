...
exports.createMotorama_catalog_tyre_brand = function() {
...
exports.readMotorama_catalog_tyre_brandEntity = function(id) {
    var connection = datasource.getConnection();
    try {
        var result;
        var sql = "SELECT * FROM MOTORAMA_CATALOG_TYRE_BRAND WHERE " + exports.pkToSQL();
        var statement = connection.prepareStatement(sql);
...
exports.readMotorama_catalog_tyre_brandList = function(limit, offset, sort, desc) {
    var connection = datasource.getConnection();
    try {
        var result = [];
        var sql = "SELECT ";
        ...
        sql += " * FROM MOTORAMA_CATALOG_TYRE_BRAND";
        if (sort !== null) {
            sql += " ORDER BY " + sort;
        }
...
// update entity by id
exports.updateMotorama_catalog_tyre_brand = function() {
    var input = request.readInputText();
...
// delete entity
exports.deleteMotorama_catalog_tyre_brand = function(id) {
    var connection = datasource.getConnection();
    try {
    	var sql = "DELETE FROM MOTORAMA_CATALOG_TYRE_BRAND WHERE " + exports.pkToSQL();
        var statement = connection.prepareStatement(sql);
...
exports.countMotorama_catalog_tyre_brand = function() {
    var count = 0;
    var connection = datasource.getConnection();
    try {
    	var sql = 'SELECT COUNT(*) FROM MOTORAMA_CATALOG_TYRE_BRAND';
        var statement = connection.prepareStatement(sql);
...
exports.metadataMotorama_catalog_tyre_brand = function() {
	var entityMetadata = {
